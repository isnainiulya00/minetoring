  ...
  const content = (
    ...
    >
      <div className="flex h-16 items-center gap-3 border-b border-gray-100 px-4">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gray-900 font-display text-xs font-bold text-white">
          MT
        </div>
        {!collapsed && (
          <div className="min-w-0">
            <p className="truncate font-display text-sm font-bold text-gray-900">MINE-TORING</p>
            <p className="truncate text-[10px] text-gray-500">Mentoring AIK</p>
          </div>
        )}
      </div>
      ...
      <button
        type="button"
        onClick={onToggle}
        className="hidden m-3 items-center justify-center gap-2 rounded-2xl border border-gray-200 py-2 text-sm text-gray-600 hover:bg-gray-50 lg:flex"
      >
